    ...
    <section id='contact' className='section-padding relative bg-gradient-to-br from-[#f7faff] via-[#e3e8f7] to-[#c7d2fe] dark:from-[#181c2b] dark:via-[#232946] dark:to-[#1e293b] transition-colors duration-700'>
      <div className='max-w-7xl mx-auto px-6 sm:px-16'>
        ...
        >
          ...
          <h2 className='heading text-4xl md:text-5xl font-extrabold text-primary-700 dark:text-primary-200 drop-shadow-lg'>Contact</h2>
        </motion.div>
        ...
        <div className='mt-12 grid grid-cols-1 lg:grid-cols-2 gap-12'>
          ...
          >
            <h3 className='text-2xl font-bold text-primary-700 dark:text-primary-200'>Let's talk</h3>
            ...
            <div className='flex flex-col gap-6 mt-4'>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <h4 className='text-lg font-medium text-primary-700 dark:text-primary-200'>Phone</h4>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <h4 className='text-lg font-medium text-primary-700 dark:text-primary-200'>Email</h4>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <h4 className='text-lg font-medium text-primary-700 dark:text-primary-200'>Location</h4>
          ...
          <motion.div
            ...
            className='flex flex-col gap-8'
          >
            <div className='glass-card p-8 rounded-2xl shadow-xl border-2 border-primary-200 dark:border-primary-700'>
              <form ref={formRef} onSubmit={handleSubmit} className='flex flex-col gap-6'>
                <div>
                  ...
                  <input
                    ...
                    placeholder='Kishore'
                    required
                    className='form-input bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-primary-200 dark:border-primary-700 placeholder-gray-400 dark:placeholder-gray-500'
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className='form-input resize-none bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-primary-200 dark:border-primary-700 placeholder-gray-400 dark:placeholder-gray-500'
                  />
                </div>

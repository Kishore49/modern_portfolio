...
const MetricFlipCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div className="glass-card-neo p-6 rounded-2xl w-full h-full flex flex-col justify-center items-center shadow-2xl border-2 border-primary-400/40 backface-hidden">
          <span className="text-5xl font-extrabold text-primary-600 drop-shadow-lg mb-2">15+</span>
          <span className="text-lg font-semibold text-gray-700 dark:text-gray-200">Projects</span>
          <span className="mt-2 text-sm text-primary-400">Click to flip</span>
        </div>
        {/* Back */}
        <div className="glass-card-neo p-6 rounded-2xl w-full h-full flex flex-col justify-center items-center absolute top-0 left-0 rotate-y-180 shadow-2xl border-2 border-primary-400/40 backface-hidden">
          <span className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">See all on GitHub</span>
          <a
            href="https://github.com/Kishore49"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-primary-500 hover:bg-primary-600 transition-colors rounded-full p-4 shadow-lg"
            title="Go to GitHub"
          >
  ...
  return (
    ...
    >
      <Tilt options={defaultTiltOptions} className="tilt-card">
        <div className="relative w-full h-full glass-card p-5 rounded-2xl sm:w-[360px] w-full shadow-xl border-2 border-primary-400/30 hover:shadow-primary-400/30 transition-shadow duration-300">
          <div className="relative w-full h-[230px]">
            ...
            <div className="absolute inset-0 flex justify-end m-3">
              <div
                ...
                className="bg-gradient-to-tr from-primary-500 to-primary-400 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer shadow-lg hover:scale-110 transition-transform"
          ...
          <div className="mt-5">
            <h3 className="text-xl font-bold text-primary-700 dark:text-primary-300">{name}</h3>
    ...
    <section id="projects" className="section-padding bg-gradient-to-br from-[#f7faff] via-[#e3e8f7] to-[#c7d2fe] dark:from-[#181c2b] dark:via-[#232946] dark:to-[#1e293b] transition-colors duration-700">
      <div className="max-w-7xl mx-auto px-6 sm:px-16">
        ...
        >
          ...
          <h2 className="heading text-4xl md:text-5xl font-extrabold text-primary-700 dark:text-primary-300 drop-shadow-lg">Projects</h2>
        </motion.div>
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-8 mt-8">
          ...
          <motion.p
            ...
            className="text-gray-700 dark:text-gray-300 text-lg max-w-3xl leading-relaxed"
          >
